    ...
    <Card className="mb-6 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 transition-colors bg-white dark:bg-gray-900">
      ...
      <CardContent className="pb-3 px-5 py-4">
        ...
        {post.images && post.images.length > 0 && (
          <PostImages
            images={post.images.map((img) => `http://localhost:3000/${img}`)}
          />
        )}
          ...
          <div className="grid grid-cols-3 gap-2 py-3">
            ...
            >
              <Heart
                className={cn(
                  "h-5 w-5",
                  isLiked && "fill-indigo-600 dark:fill-indigo-400"
                )}
              />
              Like
            </Button>
              ...
              <div className="relative flex-1">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                  <Button
                    ...
                    size="icon"
                    variant="ghost"
                    className="h-8 w-8 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900 transition"
                  >
